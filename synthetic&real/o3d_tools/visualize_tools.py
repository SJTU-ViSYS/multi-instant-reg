...
LastEditTime: 2021-11-16 16:35:39
...
def visualize_keypoint(keypts, color=[0, 0, 1], radius=0.03):
    ...
    for i in range(keypts.shape[0]):
        ...
        box_list0 += copy.deepcopy(mesh_box).translate(keypts[i].reshape([3, 1]))
    box_list0.paint_uniform_color(color)
    return box_list0
